...
- **00-Start-Here/**
  - README.md (single beginner entry point)

- **Optional-Guides/**
  - Backend-Engineer-Acceleration-Guide.md (for backend devs with 6-8 years experience)
...
- **01-Phase-Guides/**
  ...
  - PHASE-6-FUTURE-PROOFING.md
  - PHASE-7-CAPSTONE-CRUCIBLE.md
  - PHASE-8-STAFF-AI-ADDENDUM.md

- **02-Reference/**
  - COMPREHENSIVE-THEORY-GUIDE.md
  - CURRICULUM-REVIEW.md
  - ENTERPRISE-READINESS-MATRIX.md
...
- **99-End-to-End-Practice/**
  - README.md
  - complete-transition-practice-plan.md
  - lab-01-llm-api-wrapper.md
  - lab-02-rag-from-notes.md
  - lab-03-agentic-assistant.md
  - lab-04-production-hardening.md
  - lab-05-enterprise-ai-platform.md
  - lab-code/
    - beginner_agent/
    - enterprise_platform/
    - notes_rag/
...
- Phase guide: **01-Phase-Guides/PHASE-4-SENIOR-ENGINEER-DIFFERENTIATOR.md**
...
- Phase guide: **01-Phase-Guides/PHASE-5-INFRASTRUCTURE-ENTERPRISE.md**
- Review guide: **01-Phase-Guides/PHASE-5-WEEKS-23-24-REVIEW-DEEP-DIVE.md**
...
Advanced Topics & Continuous Development (content in 01-Phase-Guides/PHASE-8-STAFF-AI-ADDENDUM.md)
...
- **Interview-Preparation/**
  ...
  - use-cases-library.md

- **Papers-and-References/**
  - key-papers-summary.md
...
- **02-Reference/** - Theory, readiness, rules, review notes, and folder map
